...
export const LITE_SYSTEM_PROVIDER_IDS = [
  SystemProviderIds.openai,
  SystemProviderIds.anthropic,
  SystemProviderIds.gemini
] as const
...
export const SYSTEM_PROVIDERS: SystemProvider[] = LITE_SYSTEM_PROVIDER_IDS.map((id) => SYSTEM_PROVIDERS_CONFIG[id])
