...
export const CHERRY_STUDIO_PROTOCOL = 'lich13studio'
...
export function handleProtocolUrl(url: string) {
  ...
  // The url will be in the format: lich13studio://data?param1=value1&param2=value2
...
const DESKTOP_FILE_NAME = 'lich13studio-url-handler.desktop'

/**
 * Sets up deep linking for the AppImage build on Linux by creating a .desktop file.
 * This allows the OS to open lich13studio:// URLs with this App.
 */
