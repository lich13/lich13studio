...
crashReporter.start({
  companyName: 'lich13studio',
  productName: 'lich13studio',
  submitURL: '',
 ...
 */
if (isLinux) {
  app.commandLine.appendSwitch('class', 'lich13studio')
  app.commandLine.appendSwitch('name', 'lich13studio')
}
  ...
  void app.whenReady().then(async () => {
    ...
    void runAsyncFunction(async () => {
      ...
      try {
        ...
        logger.error('Failed to initialize agent background services:', error)
      }
    })
  })
